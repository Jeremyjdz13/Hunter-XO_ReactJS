...
export default function PhysicalEdit(props) {
    const {
        skill,
        handlePhysicalSkillChange,
        handlePhysicalSkillDelete
    } = props

    function handleChange( changes ) {
        handlePhysicalSkillChange(skill.id, { ...skill, ...changes})
    }
    ...
    return (
        <div className="grid_skills edit_input-container">
            ...
            <div className="delete_button-container">
                <button 
                    onClick={() => handlePhysicalSkillDelete(skill.id) }
